...
const enterprise = {
  ...
  challenge: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Your compliance, security, and quality frameworks were built for a world where humans wrote every line. Now AI agents are producing at a velocity your review processes were never designed to handle. You need guardrails that enable velocity without creating risk. Not policies that slow everything back down to pre-AI speed.',
      },
      {
        title: 'The Talent Arbitrage',
        description: 'Your best people are already building this way. They are the ones shipping at 10x velocity while maintaining craft. The question is whether you recognize what they are doing, create the conditions for more of it, or lose them to organizations that do.',
      },
    ],
  },

  capabilities: {
    title: 'What Zero-Vector Delivers at Scale',
    items: [
      {
        number: '01',
      ...
      {
        number: '02',
        title: 'Agent-First Team Architecture',
        description: 'Moving from one practitioner with AI agents to fifty requires structure. Shared agent configurations, specialization patterns, coordination protocols, quality gates that scale. We build the organizational architecture that lets your teams operate at extreme velocity without the chaos.',
      },
      {
        number: '03',
      ...
      },
      {
        number: '04',
        title: 'The CZVO Role',
        description: 'The Chief Zero-Vector Officer is a distinct leadership role focused on collapsing the concept-to-customer pipeline across your organization. Not a renamed CTO. Not a consultant who leaves after the engagement. A strategic function that owns the transformation, measures its impact, and scales what works.',
      },
      {
        number: '05',
  ...
  engagement: {
    ...
    models: [
      ...
      },
      {
        ...
        outcome: 'Your organization builds a self-sustaining Zero-Vector practice that outlasts any individual engagement.',
      },
    ],
  },
  ...
  contact: {
    ...
    description: 'No pitch deck. No sales process. Tell us about your organization and what you are trying to transform. If there is a fit, we will tell you what the engagement looks like and what to expect. If there is not, we will tell you that too.',
    cta: 'Book a Call',
    link: 'https://helloerikaflowers.com/book-a-call',
    email_label: 'Or get notified when we publish new enterprise-focused content.',
  },
  ...
  crosslinks: {
    builders: {
      ...
      title: 'For Builders',
      description: 'Start with the individual practice. Learn to build with AI agents before scaling.',
    },
    leaders: {
      eyebrow: 'Team Leadership',
      title: 'For Leaders',
      description: 'The organizational transformation. CZVO role, engagement models, and where to begin.',
    },
    learn: {
      eyebrow: 'The Curriculum',
      title: 'The Open Vector',
      description: 'Free, open curriculum from orientation to auteur. The knowledge base everything else builds on.',
    },
  },
};
