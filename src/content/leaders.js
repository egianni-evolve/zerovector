// For Leaders Page — Content
// Part of the Zero-Vector content layer. See en.js for the combined export.

const leaders = {
  eyebrow: 'For Leaders',
  title: 'Transform Your Organization',
  subtitle: 'You lead a team, a department, or a company. The people who move first on Zero-Vector will define the next era of product development. The ones who wait will spend years trying to catch up.',
  ...
  whatChanges: {
    title: 'What Changes When You Adopt Zero-Vector',
    items: [
      {
        label: 'Time-to-ship',
        before: 'Weeks to months. Research → design → spec → engineering → QA → deploy. Each handoff adds calendar time and communication overhead.',
        after: 'Days to weeks. The practitioner who holds the vision builds the artifact directly with AI agents. The pipeline collapses from seven steps to one continuous flow.',
      },
      {
        label: 'Signal fidelity',
        before: 'Vision degrades at every handoff. The designer draws a picture. The engineer interprets the picture. The result is 50-70% of the original intent.',
        after: 'The person with the vision ships the vision. No interpretation. No telephone game. What you imagined is what gets built.',
      },
      {
        label: 'Team leverage',
      ...
      {
        label: 'Quality',
        before: 'Quality is a function of spec fidelity. "Does the build match the design?" is the wrong question, but it is the only question the old model can answer.',
        after: 'Quality is a function of craft. The same person making the design decisions is making the build decisions. Taste is embedded directly in the artifact, not lost in translation.',
      },
    ],
  },
  ...
  forYou: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'AI is not a tool upgrade. It is a structural shift in how organizations build. The companies that treat it as a productivity boost for the existing process will be outperformed by the ones that restructure the process itself. Zero-Vector is the framework for that restructuring. The CZVO is the role that owns it.',
      },
    ],
  },
  ...
  models: {
    ...
    intro: 'Every organization is different. The right engagement depends on where you are in your transformation journey, what you are trying to achieve, and how ready your organization is for change.',
    options: [
      {
        name: 'Advisory',
      ...
      {
        name: 'Embedded',
        description: 'A hands-on Zero-Vector practitioner works alongside your team for a sprint or a quarter. They are not observing. They are shipping real production work using the Zero-Vector workflow, demonstrating it in practice while building your internal capability. Your team learns by doing, not by reading a playbook.',
        outcome: 'Best for organizations that learn by doing. Your team ships real work alongside a practitioner who has been building this way for years.',
      },
      {
        name: 'Fractional CZVO',
        description: 'A part-time Chief Zero-Vector Officer who owns the transformation strategy end to end. They audit your pipeline, build the internal playbook, establish agent-first workflows across teams, train the next generation of practitioners, define governance frameworks, and measure the impact. This is not a consulting engagement. It is a strategic leadership function.',
        outcome: 'Best for organizations ready to commit to real transformation. You get a strategic leader who builds a self-sustaining practice that outlasts the engagement.',
      },
    ],
  },
  ...
  contact: {
    ...
    description: 'Tell us about your organization and what you are trying to transform. No pitch deck. No sales process. Just a conversation about whether Zero-Vector is the right framework for what you need. If it is not, we will tell you.',
    cta: 'Book a Call',
