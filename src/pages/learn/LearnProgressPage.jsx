  ...
  if (!isLoggedIn) {
    return (
      <div className="ovl-progress-guest">
        ...
        <Link to="/open/learn/curriculum" className="ovl-btn ovl-btn-primary">
          Browse Curriculum
        </Link>
      </div>
    );
        ...
        {learn.levels.map(level => {
          ...
          return (
            <div key={level.slug} className="ovl-progress-level">
              <Link to={`/open/learn/curriculum/${level.slug}`} className="ovl-progress-level-header">
      ...
      {completedGuides > 0 && (
        <div className="ovl-progress-levels" style={{ marginTop: '32px' }}>
          ...
          <div className="ovl-progress-level">
            <Link to="/open/learn/approach" className="ovl-progress-level-header">
